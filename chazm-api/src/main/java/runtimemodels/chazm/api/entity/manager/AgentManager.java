...
public interface AgentManager {
     ...
     *
     * @param agent the {@linkplain Agent} to add.
     */
     ...
     *
     * @param agents the set of {@linkplain Agent}s to add.
     */
     ...
     *
     * @param id the {@linkplain UniqueId} that represents the {@linkplain Agent} to retrieve.
     ...
     *
     * @param id the {@linkplain UniqueId} that represents the {@linkplain Agent} to remove.
     */
     ...
     *
     * @param ids the set of {@linkplain UniqueId}s that represents the {@linkplain Agent}s to remove.
     */
