...
import static io.github.chriszhong.model.organization.event.EventCategory.ADDED;
import static io.github.chriszhong.model.organization.event.EventCategory.CHANGED;
import static io.github.chriszhong.model.organization.event.EventCategory.REMOVED;
...
import io.github.chriszhong.model.organization.event.EventFactory;
import io.github.chriszhong.model.organization.function.Effectiveness;
...
import io.github.chriszhong.model.organization.relation.RelationFactory;
...
import io.github.chriszhong.notification.Publisher;
...
class DefaultOrganization implements Organization {
	...
	public void removeAgent(@NotNull final UniqueId<Agent> id) {
		if (entities.agents.containsKey(id)) {
			...
			remove(id, relations.assignmentsByAgent, "assignmentsByAgent", c -> removeAssignment(c)); //$NON-NLS-1$
	...
	public void removeSpecificationGoal(@NotNull final UniqueId<SpecificationGoal> id) {
		if (entities.specificationGoals.containsKey(id)) {
			...
			remove(id, entities.instanceGoalsBySpecificationGoal, "instanceGoalsBySpecificationGoal", c -> removeInstanceGoal(c)); //$NON-NLS-1$
