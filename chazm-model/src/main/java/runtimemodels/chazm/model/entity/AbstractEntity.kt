...
abstract class AbstractEntity<T> @java.beans.ConstructorProperties("id") constructor(private val id: UniqueId<T>) : Identifiable<T> {
    ...
    override fun toString(): String = M.ENTITY_0.get(javaClass.simpleName, id)!!
