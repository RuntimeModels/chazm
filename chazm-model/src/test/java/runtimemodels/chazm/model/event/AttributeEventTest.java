...
public class AttributeEventTest {
    ...
    public void testAttributeEventFactory() {
        ...
        final AttributeEvent ae1 = aef.build(EventType.ADDED, a);
        final AttributeEvent ae2 = aef.build(EventType.ADDED, a);
...
//                containsString("1st parameter of AttributeEvent.<init>(AttributeEvent.java:27) is not @Nullable"),
//                containsString("2nd parameter of AttributeEvent.<init>(AttributeEvent.java:27) is not @Nullable")
//        ));
    ...
    public void testAttributeEventFactoryWithNullAttribute() {
        exception.expect(instanceOf(ProvisionException.class));
        exception.expectMessage(containsString("2nd parameter of AttributeEvent.<init>(AttributeEvent.java:27) is not @Nullable"));
    ...
    public void testGetId() {
        final Attribute a = af.buildAttribute(idf.build(Attribute.class, "a"), Attribute.Type.NEGATIVE_QUALITY);
        final AttributeEvent ae = aef.build(EventType.ADDED, a);
    ...
    public void testEquals() {
        ...
        final AttributeEvent ae1 = aef.build(EventType.ADDED, a1);
        final AttributeEvent ae2 = aef.build(EventType.ADDED, a2);
        final AttributeEvent ae3 = aef.build(EventType.ADDED, a3);
