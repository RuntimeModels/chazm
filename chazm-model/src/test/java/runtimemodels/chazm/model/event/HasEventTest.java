...
import runtimemodels.chazm.model.relation.HasFactory;
...
//                containsString("1st parameter of HasEvent.<init>(HasEvent.java:31) is not @Nullable"),
//                containsString("2nd parameter of HasEvent.<init>(HasEvent.java:31) is not @Nullable")
//        ));
