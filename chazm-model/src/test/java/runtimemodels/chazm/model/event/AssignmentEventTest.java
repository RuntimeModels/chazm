...
//                containsString("1st parameter of AssignmentEvent.<init>(AssignmentEvent.java:32) is not @Nullable"),
//                containsString("2nd parameter of AssignmentEvent.<init>(AssignmentEvent.java:32) is not @Nullable")
//        ));
