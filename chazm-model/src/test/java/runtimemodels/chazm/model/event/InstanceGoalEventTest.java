...
//                containsString("1st parameter of InstanceGoalEvent.<init>(InstanceGoalEvent.java:31) is not @Nullable"),
//                containsString("2nd parameter of InstanceGoalEvent.<init>(InstanceGoalEvent.java:31) is not @Nullable")
//        ));
