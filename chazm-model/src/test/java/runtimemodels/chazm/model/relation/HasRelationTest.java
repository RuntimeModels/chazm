...
//                containsString("1st parameter of HasRelation.<init>(HasRelation.java:39) is not @Nullable"),
//                containsString("2nd parameter of HasRelation.<init>(HasRelation.java:39) is not @Nullable")));
    ...
    public void testHasRelationFactoryWithNullAttribute() {
        ...
        exception.expect(instanceOf(ProvisionException.class));
        exception.expectMessage(containsString("2nd parameter of HasRelation.<init>(HasRelation.java:39) is not @Nullable"));
