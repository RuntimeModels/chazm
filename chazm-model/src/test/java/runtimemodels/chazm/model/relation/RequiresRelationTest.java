...
//                containsString("1st parameter of RequiresRelation.<init>(RequiresRelation.java:23) is not @Nullable"),
//                containsString("2nd parameter of RequiresRelation.<init>(RequiresRelation.java:23) is not @Nullable")
//        ));
    ...
    public void testRequiresRelationFactoryWithNullCapability() {
        ...
        exception.expect(instanceOf(ProvisionException.class));
        exception.expectMessage(containsString("2nd parameter of RequiresRelation.<init>(RequiresRelation.java:23) is not @Nullable"));
