...
//                containsString("1st parameter of PossessesRelation.<init>(PossessesRelation.java:34) is not @Nullable"),
//                containsString("2nd parameter of PossessesRelation.<init>(PossessesRelation.java:34) is not @Nullable")
//        ));
    ...
    public void testPossessesRelationFactoryWithNullCapability() {
        ...
        exception.expect(instanceOf(ProvisionException.class));
        exception.expectMessage(containsString("2nd parameter of PossessesRelation.<init>(PossessesRelation.java:34) is not @Nullable"));
