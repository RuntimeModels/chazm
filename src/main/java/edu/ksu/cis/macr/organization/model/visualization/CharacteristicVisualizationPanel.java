 ...
 * to visualize the {@link Characteristic} currently in the {@link Organization}
 * .
 * 
 ...
 * @since 6.0
 */
public class CharacteristicVisualizationPanel extends
		AbstractListVisualizationPanel<Characteristic> {
	 ...
	 * <code>CharacteristicVisualizationPanel</code>.
	 * 
	 * @param organization
	...
	public CharacteristicVisualizationPanel(final Organization organization) {
		super(organization, "Characteristics",
	...
	List<Characteristic> getCollection() {
		final List<Characteristic> characteristics = new ArrayList<>(
				getOrganization().getCharacteristics());
		final Comparator<Characteristic> comparator = new Comparator<Characteristic>() {

			@Override
			public int compare(final Characteristic characteristic1,
					final Characteristic characteristic2) {
				return characteristic1.toString().compareTo(
						characteristic2.toString());
			}
