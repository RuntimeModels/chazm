...
import edu.ksu.cis.macr.organization.model.Attribute.AttributeType;
...
public class HasRelation {
	 ...
	 *            the value of this <code>HasRelation</code>.
	 */
	HasRelation(final Agent<?> agent, final Attribute attribute,
			final double value) {
	 ...
	 */
	final void setScore(final double value) {
		final AttributeType attributeType = getAttribute().getAttributeType();
