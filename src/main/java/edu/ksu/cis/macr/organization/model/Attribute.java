...
public interface Attribute extends SimpleAttribute {
	...
	/**
	 * The <code>AttributeType</code> enumeration lists all the possible types
	 * that an <code>Attribute</code> can be.
	 * 
	 * @author Christopher Zhong
	 * @version $Revision: 1.1.4.3 $, $Date: 2010/05/25 22:18:33 $
	 * @since 5.0
	...
	/**
	 * Returns the <code>AttributeType</code> of this <code>Attribute</code>.
	 * 
	 * @return the <code>AttributeType</code> of this <code>Attribute</code>.
	 */
