 ...
 * @since 6.0
 */
public abstract class AbstractTreeVisualizationPanel extends
		AbstractVisualizationPanel implements TreeSelectionListener {
	...
	/**
	 * The <code>DefaultMutableTreeNode</code> for the
	 * <code>DefaultTreeModel</code>.
	 */
	private final MutableTreeNode root = new DefaultMutableTreeNode();

	/**
	 * The <code>DefaultTreeModel</code> that will be used by the
	 * <code>JTree</code> to display the <code>SpecificationGoal</code> and
	 * <code>InstanceGoal</code>.
	 */
	private final DefaultTreeModel treeModel = new DefaultTreeModel(root);

	/**
	 * The <code>JTree</code> used to display the <code>SpecificationGoal</code>
	 * and <code>InstanceGoal</code>.
	 */
	 ...
	 *            otherwise.
	 * @param editable
	 *            <code>true</code> if the <code>JTree</code> is editable,
	 *            <code>false</code> otherwise.
	 * @param selectionMode
	 *            the selection mode of the <code>JTree</code> which must be one
	 *            of <code>TreeSelectionModel.SINGLE_TREE_SELECTION</code>,
	 *            <code>TreeSelectionModel.CONTIGUOUS_TREE_SELECTION</code> or
	 *            <code>TreeSelectionModel.DISCONTIGUOUS_TREE_SELECTION</code>.
	 * @param rootVisible
	 *            <code>true</code> if the root node of the <code>JTree</code>
	 *            is visible, <code>false</code> otherwise.
	 * @param visibleRowCount
	 *            sets the visible row count property of the <code>JList</code>.
	 */
	protected AbstractTreeVisualizationPanel(final Organization organization,
			final String description, final int verticalScrollBarPolicy,
			final int horizontalScrollBarPolicy, final int orientation,
			final boolean oneTouchExpandable, final boolean editable,
			final int selectionMode, final boolean rootVisible,
		...
		initialize(tree, description, verticalScrollBarPolicy,
