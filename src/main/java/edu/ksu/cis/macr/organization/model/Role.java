 ...
 * Organization Model by extending the {@link SimpleRole} interface.
 * 
...
public interface Role extends SimpleRole {
	 ...
	 * <code>SpecificationGoal</code> that this <code>Role</code> achieves.
	 * 
	...
	/**
	 * Returns the set of <code>SpecificationGoal</code> that this
	 * <code>Role</code> achieves.
	 * 
	 * @return the set of <code>SpecificationGoal</code> that this
	 *         <code>Role</code> achieves.
	 */
	Set<SpecificationGoal> getAchievesSet();

	/**
	 * Removes the given <code>SpecificationGoal</code> from the set of
	 * <code>SpecificationGoal</code> that this <code>Role</code> achieves.
	 * 
	...
	/**
	 * Clears the set of <code>SpecificationGoal</code> that this
	 * <code>Role</code> achieves.
	 */
	 ...
	 * <code>Capability</code> that this <code>Role</code> requires.
	 * 
	 * @param capability
	...
	/**
	 * Returns the set of <code>Capability</code> that this <code>Role</code>
	 * requires.
	 * 
	 * @return the set of <code>Capability</code> that this <code>Role</code>
	 *         requires.
	 */
	...
	/**
	 * Clears the set of <code>Capability</code> that this <code>Role</code>
	 * requires.
	 */
	 ...
	 * <code>Attribute</code> that this <code>Role</code> influences.
	 * 
	 * @param attribute
	...
	/**
	 * Returns the set of <code>Attribute</code> that this <code>Role</code>
	 * influences.
	 * 
	 * @return the set of <code>Attribute</code> that this <code>Role</code>
	 *         needs.
	 */
	...
	/**
	 * Clears the set of <code>Attribute</code> that this <code>Role</code>
	 * influences.
	 */
	void removeAllNeeds();
	 ...
	 * <code>Characteristic</code> that this <code>Role</code> contains.
	 * 
	...
	/**
	 * Returns the set of <code>Characteristic</code> that this
	 * <code>Role</code> contains.
	 * 
	 * @return the set of <code>Characteristic</code> that this
	 *         <code>Role</code> contains.
	 */
	Set<Characteristic> getContainsSet();

	/**
	 * Returns the value of this <code>Role</code> of the containing
	 * <code>Characteristic</code> (from the given <code>UniqueIdentifier</code>
	 * ).
	 * 
	 * @param characteristicIdentifier
	 *            the <code>UniqueIdentifier</code> of the
	 *            <code>Characteristic</code> to retrieve the value.
	 * @return the value of this <code>Role</code> of the containing
	 *         <code>Characteristic</code>.
	 */
	Double getContainsValue(UniqueIdentifier characteristicIdentifier);

	/**
	 * Sets a new value for this <code>Role</code> of the containing
	 * <code>Characteristic</code> (from the given <code>UniqueIdentifier</code>
	 * ).
	 * 
	 * @param characteristicIdentifier
	 *            the <code>UniqueIdentifier</code> of the
	 *            <code>Characteristic</code> to set the new value.
	 * @param value
	 *            the new value of this <code>Role</code> of the containing
	 *            <code>Characteristic</code>.
	 */
	void setContainsValue(UniqueIdentifier characteristicIdentifier,
			double value);
	...
	/**
	 * Clears the set of <code>Characteristic</code> that this <code>Role</code>
	 * contains.
	 */
	 ...
	 * <code>PerformanceFunction</code> that is used by this <code>Role</code>.
	 * 
	...
	/**
	 * Returns the <code>PerformanceFunction</code> that is identified by the
	...
	/**
	 * Returns the set of <code>PerformanceFunction</code> that is used by this
	 * <code>Role</code>.
	 * 
	 * @return the set of <code>PerformanceFunction</code> that is used by this
	 *         <code>Role</code>.
	 */
	Set<PerformanceFunction> getUsesSet();

	/**
	 * Removes the <code>PerformanceFunction</code> (identified by the given
	 * <code>UniqueIdentifier</code>) from the set of
	 * <code>PerformanceFunction</code> that is used by this <code>Role</code>.
	 * 
	...
	/**
	 * Determines whether the given <code>SpecificationGoal</code> can be
	 * achieved by this <code>Role</code>.
	 * 
	 * @param specificationGoal
	 *            the <code>SpecificationGoal</code> to be checked.
	 * @return <code>true</code> if the <code>Role</code> is able to achieve the
	 *         given <code>SpecificationGoal</code>, <code>false</code>
	 *         otherwise.
	 */
	boolean achieves(SpecificationGoal specificationGoal);

	/**
	 * Determines whether the given <code>InstanceGoal</code> can be achieved by
	 * this <code>Role</code>.
	 * 
	 * @param instanceGoal
	 *            the <code>InstanceGoal</code> to be checked.
	 * @return <code>true</code> if the <code>Role</code> is able to achieve the
	 *         given <code>InstanceGoal</code>, <code>false</code> otherwise.
	 */
	boolean achieves(InstanceGoal<?> instanceGoal);

	/**
	 * Determines whether the given <code>Capability</code> is required by this
	 * <code>Role</code> and returns the result.
	 * 
	 * @param capability
	 *            the <code>Capability</code> to be checked.
	 * @return <code>true</code> if the <code>Capability</code> is required,
	 *         <code>false</code> otherwise.
	 */
	boolean requires(Capability capability);

	/**
	 * Determines whether the given <code>Attribute</code> is influenced by this
	 * <code>Role</code> and returns the result.
	 * 
	 * @param attribute
	 *            the <code>Attribute</code> to be checked.
	 * @return <code>true</code> if the <code>Attribute</code> is influenced,
	 *         <code>false</code> otherwise.
	 */
	boolean influences(Attribute attribute);

	/**
	 * Determines whether the given <code>Characteristic</code> is contained by
	 * this <code>Role</code> and returns value.
	 * 
	 * @param characteristic
	 *            the <code>Characteristic</code> to check.
	 * @return the <code>Double</code> value if the <code>Characteristic</code>
	 *         is contained, <code>null</code> otherwise.
	 */
	Double contains(Characteristic characteristic);

	/**
	 * Returns the score (<code>0.0</code> &le; score &le; <code>1.0</code>) of
	 * how good the given {@link Agent} plays this {@link Role} to achieve the
	 ...
	 *            goodness score.
	 * @return the goodness (<code>0.0</code> &le; score &le; <code>1.0</code>)
	 *         score of how good the given {@link Agent} plays this {@link Role}
	 *         to achieve the given {@link InstanceGoal}. A value of
	 *         <code>0.0</code> indicates that the {@link Agent} cannot perform
	 *         the {@link Role} or the {@link InstanceGoal} cannot be achieved
	 *         by the {@link Role}.
	 * @see RoleGoodnessFunction#goodness(Role, Agent, InstanceGoal, Collection)
	 */
	double goodness(Agent<?> agent, InstanceGoal<?> goal,
