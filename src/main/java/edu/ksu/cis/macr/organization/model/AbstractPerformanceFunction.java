/*
 * AbstractPerformanceFunction.java
 *
...
/**
 * The <code>AbstractPerformanceFunction</code> class implements the
 ...
 * @since 6.0
 */
public abstract class AbstractPerformanceFunction implements
		PerformanceFunction {
	...
	/**
	 * Constructs a new instance of <code>AbstractPerformanceFunction</code>.
	 * 
	 * @param identifier
	 *            the <code>UniqueIdentifier</code> representing the
	 *            <code>PerformanceFunction</code>.
	 */
	public AbstractPerformanceFunction(final UniqueIdentifier identifier) {
		if (identifier == null) {
