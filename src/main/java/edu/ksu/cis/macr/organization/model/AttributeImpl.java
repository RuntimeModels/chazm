...
public class AttributeImpl extends SimpleAttributeImpl implements Attribute {
	...
	/**
	 * The <code>AttributeType</code> of this <code>Attribute</code>.
	 */
	 ...
	 *            <code>Attribute</code>.
	 * @param attributeType
	 *            the <code>AttributeType</code> of the <code>Attribute</code>.
	 */
	...
	public String toString() {
		return String.format("%s [%s]", super.toString(), getAttributeType());
	}
