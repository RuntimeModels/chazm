...
/**
 * The <code>SimpleRoleImpl</code> class implements the {@link SimpleRole}
 * interface.
 * 
...
public class SimpleRoleImpl implements SimpleRole {
	 ...
	 * <code>SimpleRole</code> to ensure the uniqueness of
	...
	/**
	 * Returns a <code>SimpleRole</code> instance representing the given
	 * <code>UniqueIdentifier</code>.
	 * <p>
	 * If a new <>SimpleRole</code> instance is not required, this method
	 * returns the existing <code>SimpleRole</code> instance.
	 * 
	 * @param identifier
	 *            the unique <code>UniqueIdentifier</code> representing the
	 *            <code>SimpleRole</code> instance.
	 * @return a <code>SimpleRole</code> instance representing the given
	 *         <code>UniqueIdentifier</code>.
	 */
	public static final SimpleRole createSimpleRole(
