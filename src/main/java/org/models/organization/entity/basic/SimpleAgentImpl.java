...
/**
 * The <code>SimpleAgentImpl</code> class implements the {@link SimpleAgent}
 * interface.
 * 
...
public class SimpleAgentImpl implements SimpleAgent {
	 ...
	 * <code>SimpleAgent</code> to ensure the uniqueness of
	...
	/**
	 * Returns a <code>SimpleAgent</code> instance representing the given
	 * <code>UniqueIdentifier</code>.
	 * <p>
	 * If a new <>SimpleAgent</code> instance is not required, this method
	 * returns the existing <code>SimpleAgent</code> instance.
	 * 
	 * @param identifier
	 *            the unique <code>UniqueIdentifier</code> representing the
	 *            <code>SimpleAgent</code> instance.
	 * @return a <code>SimpleAgent</code> instance representing the given
	 *         <code>UniqueIdentifier</code>.
	 */
	public static final SimpleAgent createSimpleAgent(
