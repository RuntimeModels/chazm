...
public class SimpleCapabilityImpl implements SimpleCapability {
	...
	/**
	 * Returns a <code>SimpleCapability</code> instance representing the given <code>UniqueIdentifier</code>.
	 * <p>
	 * If a new <>SimpleCapability</code> instance is not required, this method returns the existing <code>SimpleCapability</code> instance.
	 *
	 * @param identifier
