...
public abstract class AbstractVisualizationPanel extends JPanel {
	...
	/**
	 * The default time (in milliseconds) for polling the
	 * <code>Organization</code> for changes.
	 */
	 ...
	 * <code>SpecificationGoal</code> and <code>InstanceGoal</code>.
	 */
	private final Organization organization;

	/**
	 * The <code>DetailedInformationPanel</code> to display additional
	 * information about the <code>Organization</code> information.
	 */
	private final DetailedInformationPanel detailedInformationPanel = new DetailedInformationPanel();

	/**
	 * An <code>AtomicBoolean</code> to indicate if the
	 * <code>AbstractListVisualizationPanel</code> is currently pulling
	 * information from the <code>Organization</code>.
	 */
	private final AtomicBoolean isPolling = new AtomicBoolean(false);

	/**
	 * An <code>AtomicBoolean</code> to indicate if the <code>Thread</code> that
	 * is currently pulling information from the <code>Organization</code> still
	 * running.
	 */
	...
	/**
	 * A <code>boolean</code> representing the first time the panel is being
	 * drawn.
	 */
	 ...
	 * 
	 * @param component
	 *            the <code>Component</code> to add to the
	 ...
	 *            otherwise.
	 */
	void initialize(final Component component, final String description,
		...
		splitPane = new JSplitPane(orientation, scrollPane,
				getDetailedInformationPanel());
		splitPane.setOneTouchExpandable(oneTouchExpandable);
		splitPane.setBorder(BorderFactory.createTitledBorder(
				BorderFactory.createCompoundBorder(
						BorderFactory.createLoweredBevelBorder(),
						BorderFactory.createRaisedBevelBorder()), description));
	...
	/**
	 * Starts pulling information from the <code>Organization</code>. Subsequent
	 * calls to this method have no effect unless the {@link #stopPolling()}
	...
	/**
	 * Stops pulling information from the <code>Organization</code>. This method
	 * only sets the value of the {@link #isPolling} to <code>false</code>.
	 */
	void stopPolling() {
		isPolling.set(false);
	}
	...
	/**
	 * Returns the <code>Organization</code> that is providing the updated
	 * information.
	 * 
	...
	/**
	 * Returns the <code>DetailedInformationPanel</code> that is used to display
	 * additional information about the <code>Organization</code>.
	 * 
	 * @return the <code>DetailedInformationPanel</code> that is used to display
	 *         additional information about the <code>Organization</code>.
	 */
	...
	/**
	 * Updates the <code>GoalVisualizationPanel</code> with the latest
	 * information from the <code>Organization</code>.
	 */
	...
	public void paint(final Graphics g) {
		/*
		 * if this is the first time, the panel is being drawn, set the divider
