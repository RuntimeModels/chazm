 ...
 * @since 3.2
 */
public class InstanceGoalEntity implements InstanceGoal, NullCheck {
	/**
	 ...
	 * @see UniqueId
	 */
	public static class Id extends AbstractId<InstanceGoal> implements NullCheck {
		/**
		 * Serial version ID
		 */
		...
		/**
		 * The {@linkplain Id} that represents the {@linkplain SpecificationGoal}.
		 */
		private final UniqueId<SpecificationGoal> specificationId;

		/**
		 * The {@linkplain Id} that represents the instance portion of the {@linkplain InstanceGoal}.
		 */
		...
		/**
		 * Returns the {@linkplain Id} that represents the {@linkplain SpecificationGoal}.
		 *
		 * @return the {@linkplain Id} that represents the {@linkplain SpecificationGoal}.
		 */
		...
		/**
		 * Returns the {@linkplain Id} that represents the instance portion of the {@linkplain InstanceGoal}.
		 *
		 * @return the {@linkplain Id} that represents the instance portion of the {@linkplain InstanceGoal}.
		 */
	 ...
	 *            the {@linkplain UniqueId} that represents the instance portion of this {@linkplain InstanceGoal}.
	 * @param parameter
	 *            the {@linkplain InstanceGoal.P} of this {@linkplain InstanceGoal}.
	 */
	public InstanceGoalEntity(final SpecificationGoal specificationGoal, final UniqueId<InstanceGoal> instanceId, final P parameter) {
		checkNotNull(specificationGoal, "specificationGoal");
		checkNotNull(instanceId, "instanceId");
