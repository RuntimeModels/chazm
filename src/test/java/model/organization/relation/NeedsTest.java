...
public class NeedsTest {
	...
	private final NeedsFactory containsFactory = injector.getInstance(NeedsFactory.class);
	...
	public void testNeeds() {
		...
		final Needs nd1 = containsFactory.buildNeeds(r, a);
		final Needs nd2 = containsFactory.buildNeeds(r, a);
	...
	public void testNeeds1() {
		...
		containsFactory.buildNeeds(null, null);
	}
	...
	public void testNeeds3() {
		...
		containsFactory.buildNeeds(r, null);
	}
	...
	public void testGetRole() {
		final Role r = roleFactory.buildRole(idFactory.build(Role.class, "r"));
		final Attribute a = attributeFactory.buildAttribute(idFactory.build(Attribute.class, "a"), Attribute.Type.NEGATIVE_QUALITY);
		final Needs nd = containsFactory.buildNeeds(r, a);
	...
	public void testEquals() {
		...
		final Attribute a = attributeFactory.buildAttribute(idFactory.build(Attribute.class, "a"), Attribute.Type.NEGATIVE_QUALITY);
		final Needs nd1 = containsFactory.buildNeeds(r1, a);
		final Needs nd2 = containsFactory.buildNeeds(r2, a);
		final Needs nd3 = containsFactory.buildNeeds(r1, a);
