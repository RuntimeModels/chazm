...
public abstract class AbstractTreeVisualizationPanel extends AbstractVisualizationPanel implements TreeSelectionListener {
     ...
     * @param editable                  <code>true</code> if the <code>JTree</code> is editable, <code>false</code> otherwise.
     * @param selectionMode             the selection mode of the <code>JTree</code> which must be one of <code>TreeSelectionModel.SINGLE_TREE_SELECTION</code>,
     *                                  <code>TreeSelectionModel.CONTIGUOUS_TREE_SELECTION</code> or <code>TreeSelectionModel.DISCONTIGUOUS_TREE_SELECTION</code>.
     * @param rootVisible               <code>true</code> if the root node of the <code>JTree</code> is visible, <code>false</code> otherwise.
