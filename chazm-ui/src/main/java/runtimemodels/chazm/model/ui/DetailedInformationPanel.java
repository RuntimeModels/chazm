...
public class DetailedInformationPanel extends JPanel {
    ...
    enum Styles {
         ...
         *
         * @param style the <code>Style</code> to be set.
         */
     ...
     * Constructs a new instance of <code>DetailedInformationPanel</code>.
     *
     * @param verticalScrollbarPolicy   the vertical scrollbar policy which must be one of <code>ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED</code>,
     *                                  <code>ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER</code>, <code>ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS</code>.
     * @param horizontalScrollbarPolicy the horizontal scrollbar policy which must be one of <code>ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED</code> ,
     ...
     *
     * @param specificationGoal the <code>SpecificationGoal</code> to process.
     */
     ...
     *
     * @param instanceGoal the <code>InstanceGoal</code> to process.
     */
...
//            }
     ...
     *
     * @param role the <code>Role</code> to process.
     */
     ...
     *
     * @param capability the <code>Capability</code> to process.
     */
     ...
     *
     * @param assignment the <code>Assignment</code> to process.
     */
...
//            }
     ...
     *
     * @param agent the <code>Agent</code> to process.
     */
     ...
     *
     * @param attribute the <code>Attribute</code> to process.
     */
     ...
     *
     * @param pmf the <code>PerformanceFunction</code> to process.
     */
     ...
     *
     * @param characteristic the <code>Characteristic</code> to process.
     */
     ...
     *
     * @param entity the <code>String</code> representing the entity to display.
     */
     ...
     * Displays the given <code>String</code> with a predetermined <code>Style</code>.
     *
     * @param relation the <code>String</code> representing the relation to display.
     */
     ...
     *
     * @param entity the <code>String</code> representing the entity to display.
     * @param score  the <code>double</code> value to display.
     */
     ...
     *
     * @param entity the <code>String</code> representing the entity to display.
     * @param value  the <code>double</code> value to display.
     */
